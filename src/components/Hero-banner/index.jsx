            ...
            <section className='hero-banner'>
                ...
                <div className='text-banner'>
                    <div className='text-content'>
                        ...
                        <h2>🌎 Join an international expat community to discover incridible thing about your new
                            home </h2><h2 className='typewriterlike'>like
                ...
                <div className='div-svg'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                        <path fill="#f8f9fa" fillOpacity="1"
                              d="M0,224L80,213.3C160,203,320,181,480,192C640,203,800,245,960,261.3C1120,277,1280,267,1360,261.3L1440,256L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z"></path>
                    </svg>
                </div>
            </section>
        </>
