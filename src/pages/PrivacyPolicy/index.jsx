...
const PrivacyPolicy = () => {
    return (
        <section className='privacy'>
            ...
            <p>At ExpatriRate, accessible from https://www.expatrirate.cf, one of our main priorities is the privacy of
                our visitors. This Privacy Policy document contains types of information that is collected and recorded
                by ExpatriRate and how we use it.</p>
            ...
            <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with
                regards to the information that they shared and/or collect in ExpatriRate. This policy is not applicable
            ...
            <p>ExpatriRate follows a standard procedure of using log files. These files log visitors when they visit
            ...
            <p>Like any other website, ExpatriRate uses 'cookies'. These cookies are used to store information including
            ...
            <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are
                used in their respective advertisements and links that appear on ExpatriRate, which are sent directly to
            ...
            <p>Note that ExpatriRate has no access to or control over these cookies that are used by third-party
                advertisers.</p>

            <h2>Third Party Privacy Policies</h2>

            <p>ExpatriRate's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you
            ...
            <p>ExpatriRate does not knowingly collect any Personal Identifiable Information from children under the age
