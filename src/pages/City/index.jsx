      ...
      {isLoading ? (
        ...
        <>
          <div className="header-city">
            ...
            <div
              className="img-show-city"
              alt={"background image of" + cityName}
            >
              <h1>{cityName}</h1>
              <h3>{country.name}</h3>
            </div>
          ...
          <h2 className="overallscore">
            <Overallborder score={city.overall}>
              Overall: <Overall score={city.overall}>{city.overall}</Overall>/5
            </Overallborder>
          </h2>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="progress">
                    <ProgressBar width={(city.activities * 100) / 5}>
                      {city.activities}/5
                    </ProgressBar>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="progress">
                    <ProgressBarCost width={(city.cost * 100) / 5000}>
                      {city.cost > 2500 ? (
                        <>
                          {city.cost}
                          <span>$/mo</span>{" "}
                ...
                <tr>
                  ...
                  <td className="progress">
                    <ProgressBar width={(city.works_places * 100) / 5}>
                      {city.works_places}/5
                    </ProgressBar>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="progress">
                    <ProgressBar width={(city.healthcare * 100) / 5}>
                      {city.healthcare}/5
                    </ProgressBar>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td className="progress">
                    <ProgressBar width={(city.safety * 100) / 5}>
                      {city.safety}/5
                    </ProgressBar>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    <i className="fa-solid fa-wifi"></i> {city.internet} Mbps
                  </td>
                </tr>
                <tr>
                ...
                {cost.length == 0 ? (
                  <tr className="no-data-city-details">No data 🥲</tr>
                ) : (
                  cost
                    .slice(0, 8)
                    .map((cost, index) => (
                      <TableCost key={index} cost={cost}></TableCost>
                    ))
                )}
