    ...
    return (
        <div className='loginform'>
            ...
            <div className='logincontent'>
                ...
                <p className='alreadymember'>Forgot password? For receive an email with password reset link, please
                    click <span onClick={() => resetpassword()}>here</span></p>
                <p className='error'>{error}</p>
                {isLoading ? <i className="fas fa-circle-notch fa-spin"></i> : null}
                <br/>
                {cookiechoice ?
                    <p>If you don't accept cookies before you log in, we won't be able to maintain your connection even
                        if you close the web page</p> :
                    <p>By accepting cookies before you log in we will be able to maintain your connection even if you
