...
const Profile = () => {
  ...
  return (
    <div className="profile">
      <img className="profilbackground" src={background} alt="background image for profile"/>
     ...
     {modifyProfile? <EditProfile user={user}/> : null}
      ...
      {favoritecity.length === 0? 
        <p>You didn't have favorite city yet ! Go discover your <Link to="/">futur place !</Link></p> 
      : 
